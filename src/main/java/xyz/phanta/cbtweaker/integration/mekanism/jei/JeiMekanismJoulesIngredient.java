...
public class JeiMekanismJoulesIngredient implements JeiIngredient<Double> {

    private final double amount;
    private final String unitSymbol;
    private final Role role;

    public JeiMekanismJoulesIngredient(double amount, String unitSymbol, Role role) {
        this.amount = amount;
    ...
    public void renderIcon(int x, int y, Double ingredient) {
        CbtTextureResources.MEKANISM_ICON_ENERGY.draw(x, y);
    }

    @Override
    public void getTooltip(Double ingredient, List<String> tooltip, ITooltipFlag tooltipFlags) {
        tooltip.add(FormatUtils.formatSI(amount, unitSymbol));
    }
