...
interface IngredientMatcher<A, JA> : JeiIngredientProvider<JA> {
    fun consumeInitial(acc: Lazy<A>, consumeFactor: Float, checkMode: Boolean): Boolean = true

    fun consumePeriodic(acc: Lazy<A>, consumeFactor: Float, checkMode: Boolean): Boolean = true
}
